...
echo -e "\n=== Node Processes ==="
ps aux | grep node | grep Mpesa Connect-api

# Check PM2 detailed status
echo -e "\n=== PM2 Details ==="
pm2 show Mpesa Connect-api | grep "exec mode"
pm2 show Mpesa Connect-api | grep "interpreter"
pm2 show Mpesa Connect-api | grep "cwd"
