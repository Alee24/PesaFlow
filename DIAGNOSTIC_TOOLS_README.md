# Mpesa Connect Diagnostic Tools

This directory contains diagnostic and troubleshooting scripts to help identify and fix connection issues in the Mpesa Connect application.

## 🛠️ Available Tools

### 1. **diagnose_connection.ps1** - Full System Diagnostic
**Purpose:** Comprehensive health check of the entire Mpesa Connect system
...
.\analyze_logs.ps1 -Service "Mpesa Connect-api"
...
1. **Backend API not running**
   - Fix: `pm2 restart Mpesa Connect-api`
...
# DATABASE_URL="mysql://root:@localhost:3306/Mpesa Connect"
...
|---------|------|--------------|
| Mpesa Connect API | 5454 | `curl http://localhost:5454/api/health` |
| Mpesa Connect Web | 5054 | `curl http://localhost:5054` |
...
# 3. Start services
cd ..
pm2 start backend/dist/server.js --name Mpesa Connect-api
...
**Version:** 1.0
**Maintainer:** Mpesa Connect Development Team
