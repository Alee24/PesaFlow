...
const profileSchema = z.object({
    ...
    // Bank Integration (Jenga/KCB/Co-op)
    jengaMerchantId: z.string().optional().or(z.literal('')),
    jengaApiKey: z.string().optional().or(z.literal('')),
    jengaApiSecret: z.string().optional().or(z.literal('')),
    jengaEnv: z.string().optional().or(z.literal('')),
    kcbConsumerKey: z.string().optional().or(z.literal('')),
    kcbConsumerSecret: z.string().optional().or(z.literal('')),
    kcbEnv: z.string().optional().or(z.literal('')),
    coopClientId: z.string().optional().or(z.literal('')),
    coopClientSecret: z.string().optional().or(z.literal('')),
