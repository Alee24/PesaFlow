...
import { stkPush, mpesaCallback, testConnection, initiateInvoicePayment, resetMpesaConfig, bulkProcess, retryPayment } from '../controllers/mpesa.controller';
...
router.post('/retry', authenticateToken, requireActive, retryPayment); // Retry Failed Disbursements
