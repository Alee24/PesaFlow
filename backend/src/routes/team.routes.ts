...
import { getTeamMembers, createTeamMember, updateTeamMember, deleteTeamMember, updateTeamMemberPin } from '../controllers/team.controller';
...
router.put('/:id/pin', updateTeamMemberPin);
