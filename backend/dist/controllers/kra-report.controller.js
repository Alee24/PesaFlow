...
exports.getKRAVATReport = void 0;
const client_1 = require("@prisma/client");
const date_fns_1 = require("date-fns");
const prisma = new client_1.PrismaClient();
const getKRAVATReport = async (req, res) => {
    try {
        ...
        sales.forEach(sale => {
            sale.items.forEach(item => {
                ...
                totalVAT += vatAmount;
                reportData.push({
                    date: (0, date_fns_1.format)(sale.createdAt, 'yyyy-MM-dd'),
        ...
        const csvRows = [
            ...
            ['Period:', `${(0, date_fns_1.format)(start, 'dd/MM/yyyy')} - ${(0, date_fns_1.format)(end, 'dd/MM/yyyy')}`],
            ['VAT Rate:', `${vatRate}%`],
            [],
        ...
        res.setHeader('Content-Disposition', `attachment; filename=KRA_VAT_Report_${(0, date_fns_1.format)(start, 'yyyy-MM')}.csv`);
        res.send(csv);
    }
    catch (error) {
...
exports.getKRAVATReport = getKRAVATReport;
//# sourceMappingURL=kra-report.controller.js.map