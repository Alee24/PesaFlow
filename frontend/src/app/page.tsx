          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-[3rem] p-12 md:p-20 relative overflow-hidden shadow-2xl shadow-indigo-500/20">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-indigo-100 mb-10 max-w-2xl mx-auto">
                Join over 5,000 Kenyan businesses using Mpesa Connect to scale faster.
              </p>
      ...
      <footer className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-gray-900 dark:text-white">Mpesa Connect</span>
          </div>
          <div className="flex flex-col items-center md:items-start text-sm text-gray-500 dark:text-gray-400">
            ...
            <p className="mt-1">
              Powered by{' '}
              <a href="https://kkdes.co.ke/" target="_blank" rel="noopener noreferrer" className="font-bold text-indigo-600 hover:underline">
