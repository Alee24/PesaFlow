...
# Mpesa Connect - Installation Guide

Welcome! This guide will help you install and configure the Mpesa Connect platform on your server.
...
1.  **Database Config**: Enter your MySQL Host, User, Password, and Database Name (e.g., `Mpesa Connect`). The installer will automatically create the schema.
...
```env
# Database
DATABASE_URL="mysql://user:pass@host:3306/Mpesa Connect"
