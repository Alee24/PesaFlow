# ============================================
# Mpesa Connect Connection Diagnostic Script
# ============================================
...
Write-Header "Mpesa Connect CONNECTION DIAGNOSTIC"
...
if ($pm2Cmd) {
    ...
    # Get recent logs for Mpesa Connect-api
    Write-Info "`nRecent Backend API logs:"
    $apiLogs = & pm2 logs Mpesa Connect-api --lines 50 --nostream 2>&1
    Write-Host $apiLogs -ForegroundColor White
    
    # Get recent logs for Mpesa Connect-web
    Write-Info "`nRecent Frontend logs:"
    $webLogs = & pm2 logs Mpesa Connect-web --lines 50 --nostream 2>&1
