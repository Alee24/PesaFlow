...
SMTP_FROM_NAME=Mpesa Connect
SMTP_FROM_EMAIL=noreply@Mpesa Connect.com

# Frontend URL
FRONTEND_URL=http://localhost:5054

# License System
MASTER_LICENSE_KEY=Mpesa Connect-MASTER-2024-ENTERPRISE-UNLIMITED
"@
    ...
    if ($dbLine) {
        ...
        Write-Info "Add: DATABASE_URL='mysql://root:@localhost:3306/Mpesa Connect'"
    }
}
